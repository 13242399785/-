<template>
  <div>
    ...
    <!-- 添加分类对话框 -->
    <el-dialog v-dialogDrag title="添加分类" :visible.sync="addDialogVisible" width="50%" @closed="addDialogClose">
    ...
    <!-- 编辑分类对话框 -->
    <el-dialog v-dialogDrag title="编辑分类" :visible.sync="editDialogVisible" width="50%">
